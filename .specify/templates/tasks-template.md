...
**Tests**: Tests are MANDATORY (PDCA TDD enforced). Every implementation task MUST have a corresponding test task written FIRST, verified to FAIL, then implementation follows. See: `.agent/skills/pdca/references/do-prompts.md`
