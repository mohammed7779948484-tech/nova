...
def _build_system_prompt(tc: TenantConfig, channel: str | None = None) -> str:
...
async def assistant_node(
    ...
    # Load tenant config once — used for both LLM creation and system prompt
    ...
    system = SystemMessage(content=_build_system_prompt(tc, channel))
